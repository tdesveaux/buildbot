...
export const BuildRequestView = observer(() => {
  ...
  const projectsQuery = useDataApiQuery(() =>
    builderQuery.getRelated((builder) => {
  ...
  const buildsetPropertiesQuery = useDataApiSinglePropertiesQuery(buildset, [], (bs) =>
    bs.getProperties(),
  );
  ...
  useTopbarItems(
    buildTopbarItemsForBuilder(builder, project, [
      ...
      {
        caption: buildRequestId.toString(),
    ...
    <div className="container">
      ...
      <Tabs id="bb-buildrequest-view-tabs">
        ...
        <Tab eventKey="debug" title="Debug">
          ...
          <RawData
            data={buildRequest !== null ? buildRequest.toObject() : {}}
            displayCallback={displayBuildRequestEntry}
          />
          <TableHeading>Buildset</TableHeading>
          <RawData
            data={buildset !== null ? buildset.toObject() : {}}
            displayCallback={displayBuildsetEntry}
          />
