...
Step 5: Draft a new release and wait for GithubAction to create release tarballs
----------------------------------------------------------------------------

The creation of the relase will trigger the 'release' Github workflow, which will build the tarballs and add them to the release.
